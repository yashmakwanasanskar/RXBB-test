...
const BillingCodeAppointment = ({
    ...
    setData((prev: any[]) =>
      prev.map((obj, idx) => {
        if (idx === index) {
          ...
          return { ...obj, ...getValues(), ...comboBoxKeyValue,definition:selectDefinition };
        } else {
  ...
  return (
    <div className="w-full ">
      {showData === true ? (
        <div className="border border-[#D4D6DD] bg-[#FFFFFF] rounded-xl drop-shadow-md">
                      ...
                      >
                        ...
                        {val.type === "comboBox" && (
                          <div className="col-span-3">
                            <ComboboxDropDown
                              label={val.value}
                              handleInputChange={val.dependValueChange?handleInputChangeComboBoxWithChangeInput:handleInputChangeComboBox}
                              doctype={val.doctype}
                              dataValue={val.data}
...
export default BillingCodeAppointment;
